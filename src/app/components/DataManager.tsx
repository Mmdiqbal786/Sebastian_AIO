...
// import { handleChange, reloadWindow } from "@/app/lib/utils";
...
//   const handleChangeDataForm = (e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement | HTMLSelectElement>) => {
//     handleChange(setCurrentEditItem)(e);
//   };
...
//   const onClickEdit = (_id: any) => handleEditClick(_id, data, setCurrentEditItem);
...
//           handleChangeDataForm({ target: { name: fieldName, value } } as React.ChangeEvent<HTMLInputElement>)
//         }
...
//           fields={[
//             { name: "password", type: "password", label: "New Password", placeholder: "Enter New Password", required: true, value: password },
//           ]}
//           onChange={(fieldName, value) =>
//             handlePasswordChange({ target: { name: fieldName, value } } as React.ChangeEvent<HTMLInputElement>)
//           }
//           onSubmit={onSubmitPasswordChange}
//           loading={loading}
//         />
//       )}
//       <DeleteModal modalOpen={currentDeleteItem !== null} itemType={entityType as any} onClose={() => setCurrentDeleteItem(null)} currentItemId={currentDeleteItem} apiEndpoint={apiEndpoint} setState={setData} toast={toast} />
...
//     }
//     console.log("Before conversion, formData.file:", formData.file);
