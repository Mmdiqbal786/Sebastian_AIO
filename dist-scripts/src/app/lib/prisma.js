...
import { relationMap } from "@/app/types/EntityType";
...
async function checkRelations(entity, id) {
    const messages = [];
...
/* ---------- Exports ---------- */
export { mongoose, MONGO_URI, models as mongooseModels, client, database, checkRelations, connectToMongoose, connectToMongoClient, db, };
